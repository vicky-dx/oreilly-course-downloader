...
class PathManager:
    ...
    @staticmethod
    def get_video_paths(course_dir: str, mod_idx: int, mod_title: str, less_idx: int, less_title: str, vid_idx: int, vid_title: str, is_audiobook: bool = False):
        ...
        ext = ".m4a" if is_audiobook else ".mp4"
